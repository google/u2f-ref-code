 ...
 * @private
 */
UserApprovedOrigins.prototype.showNotification_ =
 ...
 * @private
 */
UserApprovedOrigins.prototype.notificationClosedListener_ =
    function(id, byUser) {
 ...
 * @private
 */
UserApprovedOrigins.prototype.notificationButtonClickedListener_ =
    function(id, buttonIndex) {
  console.log(UTIL_fmt(id + ' got button click on ' + buttonIndex));
  if (this.pendingNotifications_.hasOwnProperty(id)) {
    if (buttonIndex == 0) {
