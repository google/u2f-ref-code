 ...
 * user consent via Chrome's infobars API.
 *
 */
'use strict';
 ...
 */
function InfobarUserApprovedOrigins() {
 ...
 */
InfobarUserApprovedOrigins.prototype.isApprovedOrigin =
 ...
 */
InfobarUserApprovedOrigins.prototype.approveOrigin = function(tabId) {
 ...
 */
InfobarUserApprovedOrigins.prototype.denyOrigin = function(tabId) {
  if (this.pendingApprovals_.hasOwnProperty(tabId)) {
    var originPendingApprovals = this.pendingApprovals_[tabId];
    for (var i = 0; i < originPendingApprovals.length; i++) {
